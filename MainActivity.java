...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btn_clr,btn_del,btn_eq,btn_zhengfu,btn_kaigen;
    EditText et_input;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //实例化对象
        setContentView(R.layout.activity_main);
        btn_kaigen=(Button) findViewById(R.id.btn_kaigen);
        btn_zhengfu=(Button) findViewById(R.id.btn_zhengfu) ;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_eq: //单独运算最后结果
                getResult();//调用下面的方法
                break;
            case R.id.btn_zhengfu:
//                if(!et_input.getText().equals("")){
                    double a=Double.parseDouble(et_input.getText().toString());
                    a=0-a;
                    et_input.setText((int) a+"");
//        }
//                else if (et_input.getText().equals("")){
//                    et_input.setText("");
//                }
                break;
            case R.id.btn_kaigen:
                double b=Double.parseDouble(et_input.getText().toString());
                if(b<0)
                {
                    et_input.setText("");
                    Toast.makeText(MainActivity.this,"输入错误了"
    ...
    private void getResult() {
        ...
        if(!s1.equals("")&&!s2.equals("")){
            ...
            if(!s1.equals("")&&s2.equals("0")&&op.equals("÷")){
                Toast.makeText(MainActivity.this,"输入错误了"
